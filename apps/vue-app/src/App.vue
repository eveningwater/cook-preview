    ...
    <header class="app-header">
      <div class="header-content">
        ...
        <div class="header-decoration">
          <el-icon class="decoration-icon"><Menu /></el-icon>
          <el-icon class="decoration-icon"><Coffee /></el-icon>
          <el-icon class="decoration-icon"><Shop /></el-icon>
        </div>
...
import { Food, Menu, Coffee, Shop } from '@element-plus/icons-vue';
